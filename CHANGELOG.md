...
- Expanded the scanner regression suite to 666 passing tests with 5,902 assertions across 89 files; 19 environment-specific tests remain explicitly skipped and no test fails. Formatting, generated-model drift, and TypeScript checks are clean.
