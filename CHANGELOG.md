...
- Added locked NuGet dependency graphs, self-contained `linux-x64` publication, X11 startup validation, a freedesktop launcher/desktop entry/icon, a guarded installer, and a retained CI package.
