...
public final class SafeFileGetNameWitness {
    ...
    public static void main(String[] args) throws Exception {
        Path workspace = Files.createTempDirectory("copilot-security-java-file-name-safe-");
        try {
            ...
            System.out.println("Safe File.getName witness rejected parent basenames before the sink.");
        } finally {
