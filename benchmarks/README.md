...
The versioned corpus currently contains fourteen vulnerable/control pairs:
...
server-side template injection, and check/use state races. Three runs per case
produce 84 scans in the complete corpus.
