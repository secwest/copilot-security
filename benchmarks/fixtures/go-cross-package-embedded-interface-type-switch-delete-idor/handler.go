...
import (
	"database/sql"
	primary "example.com/go-cross-package-embedded-interface-type-switch-delete-idor/internal/primary"
	service "example.com/go-cross-package-embedded-interface-type-switch-delete-idor/internal/service"
	"net/http"
)
