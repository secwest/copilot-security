...
import (
	"database/sql"
	primary "example.com/go-cross-package-safe-constructor-helper-parent-delete-authorization/internal/primary"
	service "example.com/go-cross-package-safe-constructor-helper-parent-delete-authorization/internal/service"
	"net/http"
)
