...
import (
	"database/sql"
	primary "example.com/go-cross-package-safe-nested-constructor-interface-field-delete-authorization/internal/primary"
	service "example.com/go-cross-package-safe-nested-constructor-interface-field-delete-authorization/internal/service"
	"net/http"
)
