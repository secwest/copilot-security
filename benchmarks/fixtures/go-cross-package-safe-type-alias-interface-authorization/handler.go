...
import (
	"database/sql"
	primary "example.com/go-cross-package-safe-type-alias-interface-authorization/internal/primary"
	service "example.com/go-cross-package-safe-type-alias-interface-authorization/internal/service"
	"net/http"
)
