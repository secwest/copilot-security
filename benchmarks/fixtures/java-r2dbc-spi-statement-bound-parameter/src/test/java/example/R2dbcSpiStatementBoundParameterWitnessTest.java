...
final class R2dbcSpiStatementBoundParameterWitnessTest {
    ...
    connection =
        Mono.from(
                ConnectionFactories.get(
                        "r2dbc:h2:mem:///spi_accounts_control;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE")
                    .create())
            .block();
  ...
  @Test
  void injectionShapedValueRemainsOneStatementBinding() {
