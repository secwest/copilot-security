...
import (
	...
	contracts "example.com/go-cross-package-type-alias-interface-delete-idor/internal/contracts"
)

type InvoiceID = string

type DeleteRepository interface {
	DeleteInvoice(requestContext ctx.Context, connection *database.DB, invoiceID InvoiceID) (failure error)
}
