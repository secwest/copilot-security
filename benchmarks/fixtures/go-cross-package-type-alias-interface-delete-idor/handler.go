...
import (
	"database/sql"
	primary "example.com/go-cross-package-type-alias-interface-delete-idor/internal/primary"
	service "example.com/go-cross-package-type-alias-interface-delete-idor/internal/service"
	"net/http"
)
