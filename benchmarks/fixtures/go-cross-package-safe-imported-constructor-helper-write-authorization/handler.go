...
import (
	"database/sql"
	primary "example.com/go-cross-package-safe-imported-constructor-helper-write-authorization/internal/primary"
	service "example.com/go-cross-package-safe-imported-constructor-helper-write-authorization/internal/service"
	"net/http"
)
