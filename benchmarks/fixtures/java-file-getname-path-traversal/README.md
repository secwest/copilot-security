...
This Spring fixture passes a request parameter through a service into a repository. The repository reduces the value with `java.io.File.getName()` before resolving it beneath a document root.
