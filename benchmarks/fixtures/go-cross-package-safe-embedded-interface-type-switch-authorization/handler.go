...
import (
	"database/sql"
	primary "example.com/go-cross-package-safe-embedded-interface-type-switch-authorization/internal/primary"
	service "example.com/go-cross-package-safe-embedded-interface-type-switch-authorization/internal/service"
	"net/http"
)
