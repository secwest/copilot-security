...
import (
	"database/sql"
	primary "example.com/go-cross-package-safe-imported-helper-aliased-type-switch-write-authorization/internal/primary"
	service "example.com/go-cross-package-safe-imported-helper-aliased-type-switch-write-authorization/internal/service"
	"net/http"
)
