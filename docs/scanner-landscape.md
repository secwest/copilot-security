...
Copilot Security now recognizes an exact official Spring `DatabaseClient`,
keeps request data in the `sql` grammar role distinct from `bind` values, and
requires a documented reactive execution-stage transition. It goes beyond a
sink signature by rejecting inert specifications, local or competing receiver
types, and reassignment, while requiring the reviewer to close Publisher
consumption, driver/dialect behavior, database authority, and concrete impact.
A real Spring/H2 R2DBC pair gates predicate-changing interpolation against the
same input used only as a bound value.
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [CodeQL Spring R2DBC model](https://github.com/github/codeql/pull/22279), [Spring R2DBC `DatabaseClient`](https://docs.spring.io/spring-framework/reference/data-access/r2dbc.html), [`GenericExecuteSpec`](https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/r2dbc/core/DatabaseClient.GenericExecuteSpec.html), and [R2DBC statement execution](https://r2dbc.io/spec/1.0.0.RELEASE/spec/html/#statements)                                                                                                                                                                                                                                                                                         | Spring separates SQL text or a Supplier from bound values and moves a `DatabaseClient` specification into execution through `fetch`, `then`, or mapping methods; the lower-level SPI also separates statement creation from execution.                                                                                                                                                                                                                                                                                                                                                                                                            | Require exact official receiver identity, flow only into the SQL-grammar argument, unwrap simple Supplier results, and retain the execution-stage transition across typed Java wrappers. Keep fixed SQL plus `bind`, inert specifications, lookalikes, and reassignment negative; separately validate Publisher consumption, dialect, privileges, tenancy, and concrete effect.                                                                                                                                                                                                                                                                                                                                                                                                                                        |
