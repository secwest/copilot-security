...
| [Ktor type-safe routing](https://ktor.io/docs/server-resources.html), [JDK `ProcessBuilder`](https://docs.oracle.com/en/java/javase/26/docs/api/java.base/java/lang/ProcessBuilder.html), and [CodeQL Java/Kotlin command-line injection](https://codeql.github.com/codeql-query-help/java/java-command-line-injection/)                                                                                                                                                                                                                                                                                                                                                                                                                | Ktor Resources deserializes path and query data into an annotated handler value. `ProcessBuilder` keeps an ordered command that can be replaced after construction; `start` launches one configured process and `startPipeline` launches each builder in order. A program-and-argument list does not imply a shell.                                                                                                                                                                                                                                                                                                                               | Bind only exact Ktor call or typed-resource sources and exact JDK builder identities; follow the last constructor or `command(...)` state into actual execution; distinguish executable selection and explicit command-language positions from ordinary argv; and preserve annotation, route import, builder identity, reassignment, and execution as proof obligations.                                                                                                                                                                                                                               |
