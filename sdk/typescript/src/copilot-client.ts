...
export function scanQualityGatePrompt(
  ...
  return [
    ...
    "For node-http-prototype-merge rows, preserve the exact official lodash or lodash/merge binding, the nearest package.json runtime dependency, exact evidence of a version below 4.17.11, every wrapper boundary, and remote flow into one or more merge source operands; request data used only as the target is outside this contract. Version evidence is either an exact numeric runtime declaration or a registry semver declaration whose adjacent npm package-lock.json or higher-precedence npm-shrinkwrap.json uses lockfileVersion 2 or 3, repeats that declaration exactly in packages[''], and records an exact vulnerable version at packages['node_modules/lodash']. Prove recursive traversal of __proto__ or constructor.prototype into Object.prototype or another security-relevant prototype and a concrete inherited-property, authorization, code/template execution, denial-of-service, or other effect before classifying CWE-1321. Lodash 4.17.11 and later are patched for this exact _.merge primitive; a patched resolution, stale or v1 lockfile, tag, alias, lockfile-free range or workspace declaration, devDependency, missing, malformed, oversized, or symlinked metadata, lookalike package, reassigned receiver or merge member, shallow Object.assign, or object spread does not satisfy this exact model. Independently inspect lockfile resolution, parser behavior, schema rejection of dangerous keys, null-prototype destinations, own-property checks, and whether every source operand is governed by the claimed control. Other Lodash packages, jQuery/extend families, application-defined recursive utilities, and non-npm dependency graphs require their own version and call-semantics proof.",
