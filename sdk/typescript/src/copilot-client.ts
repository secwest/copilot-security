...
export function scanQualityGatePrompt(
  ...
  return [
    ...
    "For node-http-prototype-merge rows, preserve the exact official lodash or lodash/merge binding, the nearest package.json runtime dependency pinned to an exact version below 4.17.12, every wrapper boundary, and remote flow into one or more merge source operands; request data used only as the target is outside this contract. Prove recursive traversal of __proto__ or constructor.prototype into Object.prototype or another security-relevant prototype and a concrete inherited-property, authorization, code/template execution, denial-of-service, or other effect before classifying CWE-1321. A patched version, range, tag, alias, lockfile-free workspace declaration, devDependency, missing or malformed manifest, lookalike package, reassigned receiver or merge member, shallow Object.assign, or object spread does not satisfy this exact model. Independently inspect lockfile resolution, parser behavior, schema rejection of dangerous keys, null-prototype destinations, own-property checks, and whether every source operand is governed by the claimed control. Other Lodash packages, jQuery/extend families, application-defined recursive utilities, and dependency ranges require their own version and call-semantics proof.",
