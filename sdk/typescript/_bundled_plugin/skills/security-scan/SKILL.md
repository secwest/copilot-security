...
3. Review every in-scope file. Trace attacker-controlled sources through
   validation, authentication, SAML/federated signed-assertion selection and
   trust binding, browser-ambient credential CSRF, authorization, state changes,
   interpreters, filesystem, network, deserialization, and templates;
